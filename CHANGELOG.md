...
- Inherits upstream's DIORAMA VR modes and its updated Cut tree, Celadon
  diner, mansion table and computer-desk voxelizations.
...
- Kept the Android graphics presets, cooperative terrain builds, camera
  culling, split shadow updates and companion-screen battle HUD fix.
- Inherits upstream's Stadium model and arena fixes, Viridian Forest haze,
  LOVE 12 water compatibility and roof silhouette correction.
...
- Inherits upstream's optional Stadium battles and disc stage without changing
  the normal Android defaults.
