...
Download `DRAMATIC_SHAPE-1.7.0-android.1.zip` from this repository's release page and
...
| `7`, or the **V-CURVE** mod-options row | OFF → 1 → 2 → 3 → 4 → 5 — bend the world over the horizon; 5 is a half sphere |
